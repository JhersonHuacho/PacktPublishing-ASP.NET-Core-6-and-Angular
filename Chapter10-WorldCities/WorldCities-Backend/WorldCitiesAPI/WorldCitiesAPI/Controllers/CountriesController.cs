...
namespace WorldCitiesAPI.Controllers
{
	...
	public class CountriesController : ControllerBase
	{
		...
		// GET: api/Countries
		[HttpGet("withoutDTO")]
		public async Task<ActionResult<ApiResult<Country>>> GetCountriesWithoutDTO(
			int pageIndex = 0,
			int pageSize = 10,
			string? sortColumn = null,
			string? sortOrder = null,
		...
		public async Task<ActionResult<IEnumerable<Country>>> GetCountriesWithoutPagination()
		{
